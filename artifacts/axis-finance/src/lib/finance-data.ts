...
export const seedExpenses: Expense[] = [
  ...
  { id: 'exp-gemini', nome: 'API Gemini Axis', valor_base: 50, categoria: 'assinatura', recorrencia: 'recorrente', estimado: false, cartao_id: 'card-nubank', mes_origem: '2026-01', ativo: true },
